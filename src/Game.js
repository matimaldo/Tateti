...
Ball.Game.prototype = {
	...
	create: function() {
		...
		this.add.sprite(180, 30, 'cuadro');


		this.startButton = this.add.button(60, 140, 'button-equis', this.startGame, this, 2, 0, 1);
		this.startButton.anchor.set(0.5,0);
		this.startButton.input.useHandCursor = true;

		/* var style = { font: "48px Arial", fill: "#ff0044", align: "center" };
		text = this.add.text(Ball._WIDTH*0.5-20, 40, "TIGRE", style); */
	},
	startGame: function() {
		console.log(this.startButton);
		//this.startButton = this.add.button(60, 140, 'button-start','as' , this, 2, 0, 1);
